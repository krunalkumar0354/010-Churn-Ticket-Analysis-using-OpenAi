...
def main(event):
  ...
  finalText = preText + postText + "Please take this correctness into account while generating recommended churn reason." + (correctness if correctness else "correctness is not provided.") + "do not prefix anything like Recommended Churn Reason, instead just mention the reason."
